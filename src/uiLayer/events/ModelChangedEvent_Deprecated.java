 ...
 * 
 */
public class ModelChangedEvent_Deprecated {
	 ...
	 */
	public ModelChangedEvent_Deprecated() {
	}
	 ...
	 * @param calendarEvent
	 */
	public ModelChangedEvent_Deprecated(JCalendar source, CalendarEvent calendarEvent) {
		super();
		this.source = source;
