...
/**
 * Represents the User in the system that can create a Booking on a Room.
 * 
...
public class User
{
    ...
    /**
     * Represents the possible types a User can be, different types have
     * different access levels and see different menus.
     * 
     * @author Group1 dmai0920
     */
    ...
    /**
     * Constructor 2 builds a simplified user object containing only the
     * relevant contact information for a booking.
     */
